...
function detect(ignore1, ignore2, options, callback) {
    ...
    tools.words['used to get information about your ioBroker'] = {
        'en': 'used to get information about your ioBroker',
    ...
    if (!instance) {
        instance = {
            ...
            comment: {
                add: [tools.translate(options.language, 'used to get information about your ioBroker')],
                advice: true
            }
        };
