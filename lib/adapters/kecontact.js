...
var txSocket = dgram.createSocket('udp4');
var rxSocket = dgram.createSocket('udp4');
...
function detect(ip, device, options, callback) {
    ...
    rxSocket.on('listening', function () {
        ...
        rxSocket.send("i", 0, 1, DEFAULT_UDP_PORT, ip, (err, bytes) => err && options.log.warn('Error from KeContact: ' + err));
    });
