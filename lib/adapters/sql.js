...
function detect(ip, device, options, callback) {
    ...
    tools.testPort(ip, 1433, {
        ...
        if (found) {
            var instance = tools.findInstance(options, 'sql', function (obj) {
                return (obj.native.host === ip || obj.native.host === device._name) && (obj.native.port === 1433 || !obj.native.port) && obj.native.dbtype === 'mssql';
            });
    ...
    tools.testPort(ip, 5432, {
        ...
        if (found) {
            var instance = tools.findInstance(options, 'sql', function (obj) {
                return (obj.native.host === ip || obj.native.host === device._name) && (obj.native.port === 5432 || !obj.native.port) && obj.native.dbtype === 'postgresql';
            });
            if (instance) found = false;
    ...
    tools.testPort(ip, 3306, {
        ...
        if (found) {
            var instance = tools.findInstance(options, 'sql', function (obj) {
                return (obj.native.host === ip || obj.native.host === device._name) && (obj.native.port === 3306 || !obj.native.port) && obj.native.dbtype === 'mysql';
            });
            if (instance) found = false;
