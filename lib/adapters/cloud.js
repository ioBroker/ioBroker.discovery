...
function detect(ignore1, ignore2, options, callback) {
    ...
    tools.words['used remote connection and for alexa'] = {
        'en': 'Provides the possibility to access the ioBroker at home from the internet via the ioBroker cloud. (Chargeable)',
        'de': 'Stellt die Möglichkeit zur Verfügung aus dem Internet über die ioBroker cloud auf den ioBroker Zuhause zuzugreifen. (Kostenpflichtig)',
