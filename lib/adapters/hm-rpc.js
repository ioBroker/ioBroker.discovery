...
function detect(ip, device, options, callback) {
    ...
    tools.testPort(ip, 2000, {
        ...
        if (found) {
            let instance = tools.findInstance(options, 'hm-rpc', obj =>
                (obj.native.homematicAddress === ip || obj.native.homematicAddress === device._name) && obj.native.homematicPort === 2000);
    ...
    tools.testPort(ip, 2001,  {
        ...
        (err, found, ip, port) => {
            if (found) {
                const instance = tools.findInstance(options, 'hm-rpc', obj =>
                    (obj.native.homematicAddress === ip || obj.native.homematicAddress === device._name) && obj.native.homematicPort === 2001);
    ...
    // test CUxD
    tools.testPort(ip, 8701, (err, found, ip, port) => {
        if (found) {
            const instance = tools.findInstance(options, 'hm-rpc', obj =>
                (obj.native.homematicAddress === ip || obj.native.homematicAddress === device._name) && obj.native.homematicPort === 8701);
    ...
    tools.testPort(ip, 2010, {
        ...
        if (found) {
            const instance = tools.findInstance(options, 'hm-rpc', obj =>
                (obj.native.homematicAddress === ip || obj.native.homematicAddress === device._name) && obj.native.homematicPort === 2010);
