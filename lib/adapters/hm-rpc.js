...
function detect(ip, device, options, callback) {
    ...
    tools.testPort(ip, 2000, {
        ...
        if (found) {
            var instance = tools.findInstance(options, 'hm-rpc', function (obj) {
                return (obj.native.homematicAddress === ip || obj.native.homematicAddress === device._name) && obj.native.homematicPort === 2000;
            });
    ...
    tools.testPort(ip, 2001,  {
        ...
        function (err, found, ip, port) {
            if (found) {
                var instance = tools.findInstance(options, 'hm-rpc', function (obj) {
                    return (obj.native.homematicAddress === ip || obj.native.homematicAddress === device._name) && obj.native.homematicPort === 2001;
                });
                if (instance) found = false;
    ...
    tools.testPort(ip, 8701, function (err, found, ip, port) {
        if (found) {
            var instance = tools.findInstance(options, 'hm-rpc', function (obj) {
                return (obj.native.homematicAddress === ip || obj.native.homematicAddress === device._name) && obj.native.homematicPort === 8701;
            });
            if (instance) found = false;
    ...
    tools.testPort(ip, 2010, {
        ...
        if (found) {
            var instance = tools.findInstance(options, 'hm-rpc', function (obj) {
                return (obj.native.homematicAddress === ip || obj.native.homematicAddress === device._name) && obj.native.homematicPort === 2010;
            });
            if (instance) found = false;
