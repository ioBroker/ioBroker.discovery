 ...
 */
function addInstance(ip: string, shortId: string, options: DetectOptions): boolean {
 ...
 */
function probeHttpPing(ip: string, options: DetectOptions, callback: DetectCallback): void {
