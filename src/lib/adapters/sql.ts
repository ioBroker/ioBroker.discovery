...
export function detect(ip: string, device: DiscoveryDevice, options: DetectOptions, callback: DetectCallback): void {
    ...
    tools.testPort(
        ...
        1433,
        {
            ...
            onReceive: data => data && !!data.toString().match(/<value>[.\d]+<\/value>/),
        },
        (err, found, ip): void => {
            if (found) {
                const instance = tools.findInstance(
                    ...
                    obj =>
                        ...
                        (obj.native.port === 1433 || !obj.native.port) &&
                        obj.native.dbtype === 'mssql',
                );
        ...
        (err, found, ip): void => {
            if (found) {
                const instance = tools.findInstance(
                    ...
                    obj =>
                        (obj.native.host === ip || obj.native.host === device._name) &&
                        (obj.native.port === 5432 || !obj.native.port) &&
                        obj.native.dbtype === 'postgresql',
                );
    ...
    tools.testPort(
        ...
        function (err, found, ip: string): void {
            if (found) {
                const instance = tools.findInstance(
                    options,
                    'sql',
                    obj =>
                        (obj.native.host === ip || obj.native.host === device._name) &&
                        (obj.native.port === 3306 || !obj.native.port) &&
                        obj.native.dbtype === 'mysql',
                );
