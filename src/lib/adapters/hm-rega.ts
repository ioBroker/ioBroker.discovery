...
export function detect(ip: string, device: DiscoveryDevice, options: DetectOptions, callback: DetectCallback): void {
    ...
    tools.testPort(ip, 8181, function (err, found, ip: string): void {
        if (found) {
            let instance = tools.findInstance(
                options,
                'hm-rega',
                obj =>
                    (obj.native.homematicAddress === ip || obj.native.homematicAddress === device._name) &&
                    obj.native.homematicPort === 8181,
            );
            let modified = false;
            ...
            if (
                !instance.native.hs485dAdapter &&
                !instance.native.hmipAdapter &&
                !instance.native.rfdAdapter &&
                !instance.native.cuxdAdapter
            ) {
                modified = false;
            }
...
export const dependencies = ['hm-rpc'];
