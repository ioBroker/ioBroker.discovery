...
tools.words['used for Yamaha Musiccast devices'] = {
    ...
    de: 'Stellt eine Verbindung zu Yamaha Multicast Geräten her und ermöglicht die Steuerung.',
...
export function detect(ip: string, device: DiscoveryDevice, options: DetectOptions, callback: DetectCallback): void {
    tools.httpGet(`http://${ip}:49154/MediaRenderer/desc.xml`, (error, data): void => {
