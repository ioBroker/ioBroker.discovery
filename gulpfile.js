...
function writeWordJs(data, src) {
    ...
    text += '    if (systemDictionary[word]) {\n';
    text += '        word = systemDictionary[word][lang] || systemDictionary[word].en || word;\n';
    text += '    }\n';
    text += '    word = word.replace("%s", arg1);\n';
    text += '    word = word.replace("%s", arg2);\n';
    text += '    return word;\n';
    text += '}\n';
    text += '\n';
    text += 'if (typeof module !== "undefined" && module.parent) {\n';
    text += '    module.exports = {\n';
    text += '        words:    systemDictionary,\n';
    text += '        translate: _translate\n';
    text += '    };\n';
    text += '}\n';
